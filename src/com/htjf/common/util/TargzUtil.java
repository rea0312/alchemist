 ...
 * @author LJHAI
 */
public abstract class TargzUtil {
	...
	public static void targzip(String srcPath,String destPath) throws Exception{
		
		//归档
		File tarfile = new File(destPath+".filepart");
		archive(srcPath, tarfile.getAbsolutePath());
		...
		while((count = fis.read(buffer, 0, BUFFER))!=-1){
	...
	public static void untargz(String srcPath, String destPath) throws Exception{
